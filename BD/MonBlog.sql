...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  lun. 12 mars 2018 à 16:07
...
(49, '2018-01-05 13:51:02', 'admin', 'Ceci est un commentaire', 23, 0),
(50, '2018-01-05 15:26:56', 'user', 'commentaires                                        ', 26, 0),
(54, '2018-03-12 17:02:14', 'admin', 'test', 26, 0);
...
CREATE TABLE IF NOT EXISTS `t_histoire` (
  `histoire_id` int(11) NOT NULL AUTO_INCREMENT,
...
(1, 'admin', '$2y$10$x8a6jWSMaCZjHxZJzsAHAenC9AkxZHxPbLFWPdNT/2x5No2FyajNC', 'admin', '', NULL, '', 'Administrateur', 'Autorise', 'no_picture.jpg'),

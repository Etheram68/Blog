...
<div class="col-lg-4">
    ...
    <div class="error-content">
            <!--<div class="hang-text hang-1 animated fadeInDown">
            	<img src="/blogtest/Contenu/images/error/error-4.png" alt="">
            </div>
            <div class="hang-text hang-2 animated fadeInDown">
            	<img src="/blogtest/Contenu/images/error/error-0.png" alt="" class="animated fadeInDown">
            </div>
            ...
            <p style="text-align: center;" class="error-info"></p><h3 style="text-align: center;">La page recherché n'existe pas?</h3><br>
